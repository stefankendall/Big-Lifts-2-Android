...
public class JWorkoutLogTests extends BLTestCase {
    public void testDoesNotExportAssistance() {
        ...
        assertEquals(workoutLog.bestSet(), setLog1);
    }
    ...
    public void testSerializesSetsAsUuids() {
        ...
        assertEquals(setUuids.get(0), setLog1.uuid);
    }
    ...
    public void testDeserializesUuidsAsSets() {
        ...
        assertEquals(deserializedWorkoutLog.sets.size(), 1);
        assertEquals(deserializedWorkoutLog.sets.get(0), setLog);
    }
    ...
    public void testSerializesAndDeserializesSets() {
        ...
        assertEquals(syncedLog.sets.size(), 2);

        JSetLog syncedLog1 = syncedLog.sets.get(0);
        JSetLog syncedLog2 = syncedLog.sets.get(1);
        assertEquals(syncedLog1.name, "Bench");
        assertEquals(syncedLog1.weight, new BigDecimal("100"));

        assertEquals(syncedLog2.name, "Bench");
        assertEquals(syncedLog2.weight, new BigDecimal("120"));
    }
    ...
    public void testWorkSets() {
        ...
        assertEquals(workoutLog.workSets().size(), 1);
    }
    ...
    public void testFindsBestSetFromWorkoutLog() {
        ...
        assertEquals(workoutLog.bestSet(), set2);
    }
}
